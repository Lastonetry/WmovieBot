...
<blockquote>ɪᴍ ᴛʜᴇ ᴍᴏsᴛ ᴀᴅᴠᴀɴᴄᴇ ᴀɪ ᴘᴏᴡᴇʀᴇᴅ 🤖 ғɪʟᴛʀᴏɴ ᴀɪ ʙᴏᴛ..
sᴇɴᴅ ᴍᴇ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏʀ sᴇʀɪᴇs ɴᴀᴍᴇ ᴀɴᴅ sᴇᴇ ᴍʏ ᴍᴀɢɪᴄ..✨</blockquote>
<blockquote>ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛᴀɪʟs ᴜsᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ 🤞🏻</blockquote>

ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/ThaFallenStar'>© ᴛʜᴇ ғᴀʟʟᴇɴ sᴛᴀʀ</a>
</b>"""
...
ɴᴏᴡ ɪᴛ's ᴅᴏɴᴇ.ɪ ᴡɪʟʟ ᴄᴏᴍᴘᴇʟ ʏᴏᴜʀ ᴜsᴇʀs ᴛᴏ ᴊᴏɪɴ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ/ɢʀᴏᴜᴘ, ᴀɴᴅ I ᴡɪʟʟ ɴᴏᴛ ᴘʀᴏᴠɪᴅᴇ ᴀɴʏ ғɪʟᴇs ᴜɴᴛɪʟ ʏᴏᴜʀ ᴜsᴇʀs ᴊᴏɪɴ ᴛʜᴇ ᴛᴀʀɢᴇᴛ ᴄʜᴀɴɴᴇʟ.
...
ᴛᴏ ᴄʜᴇᴄᴋ ɪғ ғsᴜʙ ɪs ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴏʀ ɴᴏᴛ, ᴜsᴇ <code>/show_fsub</code></b>"""
    ADMIN_CMD_TXT = """<b>- /m_grp ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ꜱᴇᴛ ɢʀᴘ ʟɪɴᴋ ᴏғ ᴍᴏᴠɪᴇꜱ ᴀɴᴅ ᴘᴍ ɢʀᴘ
- /stream ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ꜱᴇᴛ ꜱᴛʀᴇᴀᴍ ʟɪɴᴋ Fᴏʀ ʙᴏᴛ
- /premium ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ᴀᴅᴅ ᴘʀᴇᴍɪᴜᴍ
- /remove_premium ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ʀᴇᴍᴏᴠᴇ ᴘʀᴇᴍɪᴜᴍ
- /del_stream ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ᴅᴇʟᴇᴛᴇ ꜱᴛʀᴇᴀᴍ ʟɪɴᴋ
- /invite ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ɢᴇᴛ ɪɴᴠɪᴛᴇ ʟɪɴᴋ ғᴏʀ ᴄʜᴀᴛ
- /set_muc ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ꜱᴇᴛ ᴍᴏᴠɪᴇ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀᴛ ɪᴅ
- /del_muc ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴍᴏᴠɪᴇ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀᴛ ɪᴅ
- /post_mode ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴜꜱᴇᴅ ᴛᴏ ꜱᴇᴛ ᴘᴏꜱᴛ ᴍᴏᴅᴇ ғᴏʀ Mᴏᴠɪᴇꜱ ᴜᴘᴅᴀᴛᴇꜱ Cʜᴀɴɴᴇʟ</b>"""
    TTS_TXT="""
...
🧑🏻‍💻 ʀᴇᴘᴏ : <a href="https://t.me/ThaFallenStar">ʟɪɴᴋ</a>
</b>"""
