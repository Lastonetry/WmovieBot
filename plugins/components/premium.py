...
async def add_premium(client, message):
    try:
        ...
        custom_message = "**ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ᴊᴏɪɴɪɴɢ ᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴍᴇᴍʙᴇʀsʜɪᴘ. ɴᴏᴡ, ʏᴏᴜ ᴄᴀɴ ᴇɴᴊᴏʏ ᴘʀᴇᴍɪᴜᴍ ʙᴇɴᴇғɪᴛs ᴀᴛ ғᴜʟʟ ᴘᴏᴛᴇɴᴛɪᴀʟ, ᴅᴏ /myplan ᴛᴏ ᴋᴇᴇᴘ ᴛʀᴀᴄᴋ ɪғ ʏᴏᴜʀ ᴘʟᴀɴ ᴠᴀʟɪᴅɪᴛʏ**" if not custom_message else " ".join(custom_message)
